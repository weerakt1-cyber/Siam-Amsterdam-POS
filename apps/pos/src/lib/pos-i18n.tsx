...
const DICT = {
  ...
  memberBenefitsDesc:  { en: 'Shown on the sign-up page to attract customers. Leave empty to show defaults.', th: 'แสดงบนหน้าสมัครเพื่อดึงดูดลูกค้า — เว้นว่างไว้จะแสดงค่าเริ่มต้น' },
  addBenefit:    { en: '+ Add benefit', th: '+ เพิ่มสิทธิประโยชน์' },
  benefitTextPh: { en: 'e.g. Earn points on every order', th: 'เช่น สะสมแต้มทุกการสั่ง' },
  benefitsSaveBtn: { en: 'Save benefits', th: 'บันทึกสิทธิประโยชน์' },
  benefitsSaved:   { en: 'Saved ✓', th: 'บันทึกแล้ว ✓' },
  ...
  reserveLinkTitle: { en: 'Table reservation link', th: 'ลิงก์จองโต๊ะ' },
  reserveLinkDesc:  { en: 'Share this link or print the poster — customers scan to book a table or event. Post it on social or display it at the shop.', th: 'แชร์ลิงก์นี้หรือพิมพ์โปสเตอร์ — ลูกค้าสแกนเพื่อจองโต๊ะ/อีเวนต์ เอาไปโพสต์โซเชียลหรือแปะหน้าร้านได้เลย' },
  printPoster: { en: '🖨 Print poster', th: '🖨 พิมพ์โปสเตอร์' },
  ...
  memberPickTitle: { en: 'Select Member',   th: 'เลือกสมาชิก' },
  memberSearchPh:  { en: 'Search name or phone…', th: 'ค้นหาชื่อหรือเบอร์โทร…' },
  noMembersFound:  { en: 'No members found', th: 'ไม่พบสมาชิก' },
  couponPickTitle: { en: 'Select Coupon',   th: 'เลือกคูปอง' },
  couponNone:      { en: 'No coupon',        th: 'ไม่ใช้คูปอง' },
  memberPointsSuffix: { en: 'pts', th: 'แต้ม' },
  memberAddNew:    { en: '＋ New member',    th: '＋ เพิ่มสมาชิกใหม่' },
  memberNamePh:    { en: 'Member name',      th: 'ชื่อสมาชิก' },
  memberPhonePh:   { en: 'Phone (optional)', th: 'เบอร์โทร (ไม่บังคับ)' },
  memberAddSave:   { en: 'Add & select',     th: 'เพิ่มและเลือก' },
  memberAddFailed: { en: 'Could not add member', th: 'เพิ่มสมาชิกไม่สำเร็จ' },
  // Loyalty settings
  setLoyaltyTitle:   { en: 'Loyalty — Points & Stamps', th: 'สะสมแต้ม & แสตมป์' },
  setBahtPerPoint:   { en: '฿ per 1 point',   th: 'กี่บาท = 1 แต้ม' },
  setBahtPerPointHint: { en: 'e.g. 10 → ฿10 spent = 1 point (× tier bonus)', th: 'เช่น 10 → ใช้จ่าย ฿10 = 1 แต้ม (× โบนัส tier)' },
  setStampAuto:      { en: 'Auto visit stamps on payment', th: 'เปิดแสตมป์อัตโนมัติเมื่อจ่ายเงิน' },
